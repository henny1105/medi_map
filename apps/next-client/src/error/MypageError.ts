...
export class UpdateNicknameError extends Error {
  constructor(message = ALERT_MESSAGES.ERROR.UPDATE_NICKNAME) {
    super(message);
...
export class UpdatePasswordError extends Error {
  constructor(message = ALERT_MESSAGES.ERROR.UPDATE_PASSWORD) {
    super(message);
...
export class DeleteAccountError extends Error {
  constructor(message = ALERT_MESSAGES.ERROR.DELETE_ACCOUNT) {
    super(message);
