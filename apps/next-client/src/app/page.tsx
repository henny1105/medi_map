    ...
    <div>
        ...
        <div className="video_cont">
          ...
          <div className="txt_box">
            ...
            <div className="search_box">
              <input
                type="text"
                placeholder="찾아보고 싶은 약물이름을 검색해주세요. 예) 게보린 💊"
                value={searchTerm}
        ...
        <div className="inner">
          ...
          <div className="top_cont">
            ...
            <p className="desc_txt">
              건강을 지키기 위해서는 정확한 약물 정보와 접근 가능한 약국 위치가 중요합니다.
              <br />
              MediMap은 사용자가 손쉽게 약물을 검색하고, 주변 약국 위치를 한눈에 확인할 수 있도록
              도와줍니다.
            </p>
          </div>
      ...
      <section className="sec03">
        <div className="inner">
          ...
          <p className="desc_txt">
            MediMap은 실제 사용자들의 상황을 바탕으로 설계되었습니다.
            <br />
            ...
            <div className="top_cont">
              <div className="item">
                ...
                <div className="txt_cont">
                  ...
                  <p className="txt_desc">복잡한 정보 말고 딱 필요한 핵심 정보만 알려주면 좋겠어요.</p>
                </div>
              </div>
            ...
            <div className="bottom_cont">
              ...
              <div className="item">
                ...
                <div className="txt_cont">
                  ...
                  <p className="txt_desc">
                    건강 관리도 꾸준히 해야 하니까 내가 매번 복용하는 약물 목록을 저장해두고 확인하고
                    싶어요.
                  </p>
